...
function TermsOfUse() {
  ...
  return (
    <div className="container mx-auto p-4 pt-4 text-white">
      <h1 className="text-2xl font-bold text-gold mb-4">Conditions d'Utilisation d'Autoboss</h1>
      ...
      <h2 className="text-xl font-bold text-gold mb-2">1. Rôle d'Autoboss</h2>
      <p className="mb-4">
      ...
      <h2 className="text-xl font-bold text-gold mb-2">2. Engagement à l'Authenticité</h2>
      <p className="mb-4">
      ...
      <h2 className="text-xl font-bold text-gold mb-2">3. Limitation de Responsabilité</h2>
      <p className="mb-4">
      ...
      <h2 className="text-xl font-bold text-gold mb-2">4. Notifications Push</h2>
      <p className="mb-4">
      ...
      <h2 className="text-xl font-bold text-gold mb-2">5. Droit Applicable et Juridiction</h2>
      <p className="mb-4">
      ...
      <h2 className="text-xl font-bold text-gold mb-2">6. Modifications</h2>
      <p className="mb-4">
      ...
      <p className="mb-4">
        <strong>Contact</strong> : Pour toute question, contactez-nous au <a href="https://wa.me/+221762641751" className="text-gold underline hover:text-yellow-400">+221 76 264 17 51</a>.
      </p>
