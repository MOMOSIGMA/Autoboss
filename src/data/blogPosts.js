...
const blogPosts = {
  'conseils-pour-acheter-une-voiture-doccasion': {
    ...
    excerpt: 'Acheter une voiture d’occasion peut être une excellente option pour économiser de l’argent, mais cela comporte aussi des risques. Voici quelques conseils concrets pour réussir votre achat au Sénégal.',
    content: `
  ...
  'comment-louer-une-voiture-au-senegal': {
    ...
    excerpt: 'La location de voiture est une solution très pratique au Sénégal, que ce soit pour un séjour temporaire à Dakar, un déplacement à l’intérieur du pays ou pour éviter les transports en commun.',
    content: `
  ...
  'comment-importer-une-voiture-au-senegal': {
    ...
    excerpt: 'Importer une voiture au Sénégal peut être rentable, surtout pour les véhicules de qualité venant d’Europe, d’Amérique ou d’Asie.',
    content: `
  ...
  'comment-vendre-rapidement-sa-voiture-au-senegal': {
    ...
    excerpt: 'Vous souhaitez vendre votre voiture sans perdre de temps ? Voici des astuces spécifiques au marché sénégalais pour maximiser vos chances.',
    content: `
